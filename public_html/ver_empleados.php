	            ...
	            <article class="characteristics__item; card">
		            <ul class="list-group list-group-flush">
			            <form method='post' action=''>
                            ...
                            <li class="list-group-item"><div>Ciudad: <div><?php echo $row['Ciudad'];?></div></li>
                            ...
                            <li class="list-group-item"><div>Sueldo: <div><?php echo $row['Sueldo'];?></div></li>
                            <li class="list-group-item"><div>Tipo: <div><?php echo $row['Tipo'];?></div></li>
			            </form>
			        </ul>
                </article>
                <?php } 
