      ...
      <section class="hero3">
          <form class="contact100-form validate-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data" method="post" id="alta">
              ...
              <div class="container-contact100-form-btn p-1">
                  ...
                  <select name="residente" id="residente" class="input100 mr-3">
              ...
              <div class="container-contact100-form-btn p-1">
                  ...
                  <input class="input100" type="number" id="idC" name="idC" value="<?php echo $_SESSION['cant']; ?>">
              </div>
              <br>
              ...
              <div class="container-contact100-form-btn p-1">
                  ...
                  <span class="label-input100 pl-3">Cantidad:</span>
                  <input class="input100" type="cantidadM" id="idMedic" name="idMedic" value="<?php echo $_SESSION['cantmed']; ?>">
                  <span class="focus-input100"></span>
              </div>
              <hr>
