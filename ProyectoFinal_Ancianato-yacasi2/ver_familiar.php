...
<body>
                ...
                <article class="characteristics__item; card bg-light mb-3 border-dark">
                    <ul class="list-group list-group-flush">
                        <form method='post' action=''>
                            ...
                            <li class="list-group-item">
                                Apellido P: <?php echo $row['Apellido_P']; ?>
                            </li>
                            <li class="list-group-item">
                            Apellido M: <?php echo $row['Apellido_M']; ?>
                            </li>
                            <li class="list-group-item">
                                Fecha de nacimiento: <?php echo $row['Fecha_Nac']; ?>
                            </li>
                            <li class="list-group-item">
                                Calle y No: <?php echo $row['CalleNo']; ?>
                            </li>
                            <li class="list-group-item">
                                Colonia: <?php echo $row['Colonia']; ?>
                            </li>
                            <li class="list-group-item">
                                CP: <?php echo $row['CP']; ?>
                            </li>
                            <li class="list-group-item">
                                Ciudad: <?php echo $row['Cuidad']; ?>
                            </li>
                            <li class="list-group-item">
                            ...
                            <li class="list-group-item">
                                Parentezco: <?php echo $row['Parentezco']; ?>
                            </li>
                            <li class="list-group-item">
    ...
    <footer class="bg-light py-5">
        <div class="container">
            <div class="small text-center text-muted">Copyright © 2020 - Copyright © 2020 - Ancianato. El mejor tiempo de vida.</div>
        </div>
    </footer>
