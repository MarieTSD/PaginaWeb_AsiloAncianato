...
<html lang="en">
    ...
    <body >
        ...
        <section class="page-section bg-dark text-white">
            <div class="container text-center">
                <h2 class="mb-4">ALTA MEDICINA</h2>
            </div>
        </section>
    ...
    <div class="container">
        ...
        <div class="wrap-input100 validate-input" data-validate = "Requerido">
            ...
            <input class="input100" type="text" id="des" name="via" placeholder="Flores" required>
            <span class="focus-input100"></span>
        </div>

        <div class="wrap-input100 validate-input">
            <span class="label-input100">Via:</span>
            <input class="input100" type="text" id="via" name="via" placeholder="Serna">
            <span class="focus-input100"></span>
        </div>

        
        <div class="container-contact100-form-btn">
            <button class="contact100-form-btn" onclick="getDataMed()" name="submit">
                <span>
                    Agregar Medicina
