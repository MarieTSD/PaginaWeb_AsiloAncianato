...
<body>
    ...
    <section class="bg-primary text-white h-25">
        <div class="container text-center pt-5">
            <h2 class="mb-2 pt-5">ALTA SUMINISTRO</h2>
        </div>
    </section>
    ...
    <section class="hero3">
        <form class="contact100-form validate-form" action="altas_suministro_bd.php" enctype="multipart/form-data" method="POST" id="alta">
            ...
            <div class="wrap-input100 validate-input p-1" data-validate="Requerido">
                ...
                <input class="input100" type="text" id="nomA" name="nomA" placeholder="Agua" required>
                <span class="focus-input100"></span>
            </div>

            <div class="wrap-input100 validate-input p-1" data-validate="Requerido">
                <span class="label-input100">Descripcion: </span>
                <input class="input100" type="text" id="desA" name="desA" placeholder="Embotellada 1L" required>
                <span class="focus-input100"></span>
            </div>
