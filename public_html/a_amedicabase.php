...
<body>
    ...
    <section class="bg-primary text-white h-25">
        <div class="container text-center pt-5">
            <h2 class="mb-2 pt-5">ACTUALIZAR CAMPOS ACTUALIZAR ATENCION MEDICA</h2>
        </div>
    </section>
    ...
    <section class="hero3">
        <form class="contact100-form validate-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"
            ...
            <div class="wrap-input100 validate-input p-1" data-validate="Requerido">
                ...
                <input class="input100" type="text" name="apA" value="<?php echo $_SESSION['calleno']; ?>" required>
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input p-1" data-validate="Requerido">
                <span class="label-input100">Colonia:</span>
                <input class="input100" type="text" name="amA" value="<?php echo $_SESSION['colonia']; ?>">
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input p-1" data-validate="Requerido">
                <span class="label-input100">Codigo Postal:</span>
                <input class="input100" type="number" name="nacA" value="<?php echo $_SESSION['cp']; ?>" required>
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input p-1" data-validate="Requerido">
                <span class="label-input100">Ciudad:</span>
                <input class="input100" type="text" name="calleA" value="<?php echo $_SESSION['ciudad']; ?>" required>
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input p-1" data-validate="Requerido">
                <span class="label-input100">Estado:</span>
                <input class="input100" type="text" name="coloniaA" value="<?php echo $_SESSION['estado']; ?>" required>
            </div>
            <div class="wrap-input100 validate-input p-1" data-validate="Requerido">
                <span class="label-input100">RFC:</span>
                <input class="input100 w-20px" type="text" name="cpA" value="<?php echo $_SESSION['rfc']; ?>" required>
                <span class="focus-input100"></span>
            </div>
            <div class="wrap-input100 validate-input p-1" data-validate="Requerido">
                <span class="label-input100">Telefono:</span>
                <input class="input100" type="num" name="ciudadA" value="<?php echo $_SESSION['telefono']; ?>" required>
                <span class="focus-input100"></span>
            </div>
