    ...
    <body >
        ...
        <section class="bg-primary text-white h-25">
            <div class="container text-center pt-5">
                <h2 class="mb-2 pt-5">BAJA DONACION</h2>
            </div>
        </section>
        ...
        <section class="hero3 hero7">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                <div class="wrap-input100 validate-input; contact100-form validate-form;" data-validate="Requerido">
                    <input class="input100" type="number" name="idD" placeholder="Ingresa id">
        ...
        <?php
            ...
            if($conexion->connect_error){
                ...
                if(isset($_POST['submit'])){
                    ...
                    if($fila){
                        echo "<script>document.location='baja_donacionbase.php';</script>";
                    }else{
