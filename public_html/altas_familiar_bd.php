  ...
  if($conexion->connect_error){
      ...
      //Sacamos los valores con post
                ...
                //hacemos cadena con la sentencia mysql para insertar datos
                    $sql = "INSERT INTO familiar (Nombre,Apellido_P, Apellido_M,Fecha_Nac,Parentezco,CalleNo,Colonia,CP,Cuidad,Estado,Telefono,ID_Residente) VALUES ('$nom', '$apP', '$apM', '$anoN', '$paren', 
