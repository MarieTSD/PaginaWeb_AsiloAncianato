...
<head>
    ...
    <script type="text/javascript" src="JS/se_encarga.js"></script>
...
<body>
    ...
    <section class="bg-dark text-white h-20 " style="height:20%;">
        <div class="container text-center pt-5">
            <h2 class="mb-2 pt-5">ALTA DE CRONOGRAMA DE CUIDADOS</h2>
        </div>
    </section>
    ...
    <section class="hero3">
        <form id="form">
            ...
            <div class="container-contact100-form-btn p-1">
                <button class="btn btn-outline-info w-50 p-3 m-1" onclick="getDataSE()" name="submit">
                    <span>
                        AGREGAR
