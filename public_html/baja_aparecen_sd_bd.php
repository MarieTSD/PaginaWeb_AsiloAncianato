    ...
    <body >
        ...
        <section class="bg-primary text-white h-25">
            <div class="container text-center pt-5">
                <h2 class="mb-2 pt-5">CONFIRMAR BAJA APARECEN_SD</h2>
            </div>
        </section>
            ...
            <script>
                swal({
                    ...
                    if (willDelete) {
                        ...
                        document.location="baja_apa_sd.php";
                    } else {
                        swal("No eliminado");
                        document.location="baja_aparecen_sd_bd.php";  
                    }
                });
            </script>';
            }
        ...
        <section class="hero3">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                <table class="table table-hover table-bordered w-50">
                    <tr>
                        <td>Codigo Suministro </td>
                        <td><?php echo $_SESSION['idS'], " - ", $_SESSION['nom']; ?></td>
                    </tr>
                    <tr>
                        <td>ID Donacion: </td>
                        <td><?php echo $_SESSION['idD'], " - ", $_SESSION['apo']; ?></td>
                    </tr>
                    <tr>
                        <td>Cantidad: </td>
